...
const HomeDashboad = () => {
  ...
  const handleContinue = () => {
    navigate(
      `/create-transaction?itemName=${itemName}&amount=${amount}&currency=${currency}&initiator=${initiatorRole}`
    );
  };
      ...
      <div className="lg:px-[15rem] px-3">
        <div className="flex justify-center items-center text-center h-screen">
          <div className="w-full">
            <img
              src={dashboardImages.empty1}
              alt=""
              className="w-24 flex m-auto justify-center pb-5"
            />
              ...
              <div className="pb-3">
                ...
                <div className="flex items-center gap-3">
                  <p
                    ...
                    className={`${
                      isBuyer === true
                        ? "bg-[#054FBB] w-fit hover:bg-blue-600  text-white"
                ...
                {isBuyer === false && isSeller === false && (
                  <p className="text-red-500 text-sm pt-3">
                    Please select a role either buyer/seller
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-7 pt-5">
                <div>
                  <p className="text-sm pb-2">
                    What item are you buying/selling?
                  </p>
                  <input
                    type="text"
                    required
